...
class Smiley:
    def __init__(self, x, y, radius, eyes_radius):
        ...
        self.happy = True  # Initial expression is happy
    ...
    def draw(self):
        ...
        if self.happy:
            ...
            pygame.draw.ellipse(screen, BLACK, (self.x - self.radius, self.y - int(self.radius * 0.8), self.radius * 2, self.radius * 1.6))
        ...
        if self.happy:
            ...
            pygame.draw.arc(screen, BLACK, (self.x - int(self.radius / 2), self.y + int(self.radius / 2), self.radius, int(self.radius / 2)), math.pi, 2*math.pi, 3)
...
# Randomly change expressions after the screen is opened
for smiley in smileys:
    smiley.happy = bool(random.getrandbits(1))
