...
class DragAndDropApp:
    ...
    def on_drag_start(self, event):
        self.drag_data["item"] = event.widget  # Set the item being dragged
    ...
    def on_drag_motion(self, event):
        x, y = event.x_root - self.master.winfo_rootx() - self.drag_data["x"], \
           event.y_root - self.master.winfo_rooty() - self.drag_data["y"]
